...
const I = ({ size: r, color: t, ...i }) => /* @__PURE__ */ o(m, { size: r, color: t, children: /* @__PURE__ */ p(
  "svg",
  {
    viewBox: "0 0 32 32",
    fill: "none",
    ...
    children: [
      /* @__PURE__ */ o(
        "path",
        {
          d: "M4 5C4 4.44772 4.44772 4 5 4H21C21.5523 4 22 4.44772 22 5V9H20V6H6V20H9V22H5C4.44772 22 4 21.5523 4 21V5Z",
          fill: "currentColor"
        }
      ),
      /* @__PURE__ */ o(
        "path",
        {
          d: "M10 11.125C10 10.5037 10.5037 10 11.125 10H26.875C27.4963 10 28 10.5037 28 11.125V26.875C28 27.4963 27.4963 28 26.875 28H11.125C10.5037 28 10 27.4963 10 26.875V11.125ZM12 26V12H26V26H12Z",
          fill: "currentColor",
          fillRule: "evenodd",
          clipRule: "evenodd"
        }
