...
const I = ({ size: r, color: i, ...t }) => /* @__PURE__ */ o(l, { size: r, color: i, children: /* @__PURE__ */ p(
  "svg",
  {
    viewBox: "0 0 32 32",
    fill: "none",
    ...
    children: [
      /* @__PURE__ */ o(
        "path",
        {
          d: "M4 6C4 4.89543 4.89543 4 6 4H13C14.1046 4 15 4.89543 15 6V13C15 14.1046 14.1046 15 13 15H6C4.89543 15 4 14.1046 4 13V6ZM6 6H13V13H6V6Z",
          fill: "currentColor",
          fillRule: "evenodd",
          clipRule: "evenodd"
        }
      ...
      /* @__PURE__ */ o(
        "path",
        {
          d: "M17 6C17 4.89543 17.8954 4 19 4H26C27.1046 4 28 4.89543 28 6V13C28 14.1046 27.1046 15 26 15H19C17.8954 15 17 14.1046 17 13V6ZM19 6H26V13H19V6Z",
          fill: "currentColor",
          fillRule: "evenodd",
          clipRule: "evenodd"
        }
      ...
      /* @__PURE__ */ o(
        "path",
        {
          d: "M6 17C4.89543 17 4 17.8954 4 19V26C4 27.1046 4.89543 28 6 28H13C14.1046 28 15 27.1046 15 26V19C15 17.8954 14.1046 17 13 17H6ZM13 19H6V26H13V19Z",
          fill: "currentColor",
          fillRule: "evenodd",
          clipRule: "evenodd"
        }
      ...
      /* @__PURE__ */ o(
        "path",
        {
          d: "M21.5 18.5C21.5 17.9477 21.9477 17.5 22.5 17.5C23.0523 17.5 23.5 17.9477 23.5 18.5V21.5H26.5C27.0523 21.5 27.5 21.9477 27.5 22.5C27.5 23.0523 27.0523 23.5 26.5 23.5H23.5V26.5C23.5 27.0523 23.0523 27.5 22.5 27.5C21.9477 27.5 21.5 27.0523 21.5 26.5V23.5H18.5C17.9477 23.5 17.5 23.0523 17.5 22.5C17.5 21.9477 17.9477 21.5 18.5 21.5H21.5V18.5Z",
          fill: "currentColor"
        }
      )
    ]
