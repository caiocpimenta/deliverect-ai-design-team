  ...
  "svg",
  {
    ...
    children: [
      /* @__PURE__ */ o(
        "path",
        {
          d: "M6 5C4.89543 5 4 5.89543 4 7V9C4 10.1046 4.89543 11 6 11H26C27.1046 11 28 10.1046 28 9V7C28 5.89543 27.1046 5 26 5H6ZM26 7H6L6 9H26V7Z",
          fill: "currentColor",
          fillRule: "evenodd",
          clipRule: "evenodd"
        }
      ...
      /* @__PURE__ */ o(
        "path",
        {
          d: "M6 13C4.89543 13 4 13.8954 4 15V17C4 18.1046 4.89543 19 6 19H26C27.1046 19 28 18.1046 28 17V15C28 13.8954 27.1046 13 26 13H6ZM26 15H6L6 17H26V15Z",
          fill: "currentColor",
          fillRule: "evenodd",
          clipRule: "evenodd"
        }
      ...
      /* @__PURE__ */ o(
        "path",
        {
          d: "M4 23C4 21.8954 4.89543 21 6 21H26C27.1046 21 28 21.8954 28 23V25C28 26.1046 27.1046 27 26 27H6C4.89543 27 4 26.1046 4 25V23ZM6 23H26V25H6L6 23Z",
          fill: "currentColor",
          fillRule: "evenodd",
          clipRule: "evenodd"
        }
