...
const F = ({ size: o, color: i, ...t }) => /* @__PURE__ */ r(p, { size: o, color: i, children: /* @__PURE__ */ r(
  "svg",
  {
    viewBox: "0 0 32 32",
    fill: "none",
    ...
    children: /* @__PURE__ */ r(
      "path",
      {
        d: "M30 16C30 23.732 23.732 30 16 30C8.26802 30 2 23.732 2 16C2 8.26802 8.26802 2 16 2C23.732 2 30 8.26802 30 16ZM17 8C17 7.44771 16.5523 7 16 7C15.4477 7 15 7.44772 15 8V18C15 18.5523 15.4477 19 16 19C16.5523 19 17 18.5523 17 18V8ZM16 21C15.1716 21 14.5 21.6716 14.5 22.5C14.5 23.3284 15.1716 24 16 24C16.8284 24 17.5 23.3284 17.5 22.5C17.5 21.6716 16.8284 21 16 21Z",
        fill: "currentColor",
        fillRule: "evenodd",
        clipRule: "evenodd"
      }
