...
const I = ({ size: o, color: t, ...i }) => /* @__PURE__ */ r(m, { size: o, color: t, children: /* @__PURE__ */ p(
  "svg",
  {
    viewBox: "0 0 32 32",
    fill: "none",
    ...
    children: [
      /* @__PURE__ */ r(
        "path",
        {
          d: "M20 6C20 4.89543 19.1046 4 18 4H6C4.89543 4 4 4.89543 4 6V26C4 27.1046 4.89543 28 6 28H18C19.1046 28 20 27.1046 20 26V19H18V26H6V6H18V13H20V6Z",
          fill: "currentColor"
        }
      ),
      /* @__PURE__ */ r(
        "path",
        {
          d: "M12.0227 17.0227H24.172L22.4709 18.8441C22.1 19.2412 22.1071 19.8598 22.487 20.2483C22.8888 20.6593 23.5512 20.6555 23.9483 20.2399L28 16L23.9483 11.7601C23.5512 11.3445 22.8888 11.3407 22.487 11.7517C22.1071 12.1402 22.1 12.7588 22.4709 13.1559L24.172 14.9773L12.0227 14.9773C11.4579 14.9773 11 15.4352 11 16C11 16.5648 11.4579 17.0227 12.0227 17.0227Z",
          fill: "currentColor"
        }
      )
    ]
