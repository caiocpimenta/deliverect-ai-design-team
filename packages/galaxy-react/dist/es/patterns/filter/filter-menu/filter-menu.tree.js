...
import { DropdownMenuRoot as c } from "../../../components/dropdown-menu/dropdown-menu-root.js";
...
import { DropdownMenuButtonTrigger as f } from "../../../components/dropdown-menu/dropdown-menu-trigger.js";
...
import { LoadingSpinner as h } from "../../../primitives/loading-spinner/loading-spinner.js";
...
import { Filter2 as M } from "../../../foundations/icons/filter-2.js";
...
import { Text as e } from "../../../foundations/typography/text/text.js";
...
import { FilterMenuTreeItem as v } from "./filter-menu.tree-item.js";
import { resolveFilterKey as w } from "./util.js";
const Oo = ({
  label: n,
  isLoading: o,
  isLoadingLabel: l,
  ...
  return /* @__PURE__ */ p(c, { children: [
    /* @__PURE__ */ r(
      f,
      {
        ...
        disabled: o,
        LeadingIcon: o ? void 0 : /* @__PURE__ */ r(M, {}),
        children: o ? /* @__PURE__ */ p(g, { space: "sm", children: [
          /* @__PURE__ */ r(h, { status: "neutral", size: "sm" }),
          /* @__PURE__ */ r(e, { weight: "medium", color: "inactive", children: l })
        ] }) : /* @__PURE__ */ r(e, { weight: "medium", children: n })
      }
    ),
    /* @__PURE__ */ r(a, { align: "start", children: Object.entries(s).map(([t, i]) => /* @__PURE__ */ r(
      v,
      {
        config: i,
        onClick: (m) => u(t, m)
