...
import { FilterMenuProvider as a } from "./filter-menu.context.js";
...
import { FilterMenuElements as f } from "./filter-menu.elements.js";
import { FilterMenuTree as h } from "./filter-menu.tree.js";
const x = ({
  label: n,
  isLoading: o = !1,
  isLoadingLabel: s = "",
  ...
  return /* @__PURE__ */ i(
    a,
    {
      openFilterKey: F,
      setOpenFilterKey: e,
      setAppliedFilterKeys: p,
      children: /* @__PURE__ */ d(M, { space: "2xs", className: u, children: [
        /* @__PURE__ */ i(
          h,
          {
            label: n,
