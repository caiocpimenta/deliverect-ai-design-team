...
import { filterCalendarFooterButton as s } from "../../../../galaxy-styles/dist/filter/filter-calendar.css.js";
import { baseReset as n } from "../../../../galaxy-styles/dist/tokens/reset.css.js";
const f = e(({ className: r, applyLabel: o, onValueApplyChange: t }, m) => {
  const i = l(
    n,
    s,
    r
...
f.displayName = "Filter.CalendarFooterApply";
export {
  f as FilterCalendarFooterApply
};
