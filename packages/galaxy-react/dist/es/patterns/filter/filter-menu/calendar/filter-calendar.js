...
import { DropdownMenuContent as x } from "../../../../components/dropdown-menu/dropdown-menu-content.js";
...
import { DropdownMenuRoot as T } from "../../../../components/dropdown-menu/dropdown-menu-root.js";
...
import { DropdownMenuTrigger as j } from "../../../../components/dropdown-menu/dropdown-menu-trigger.js";
...
import { useClearFilter as I, useToggleOpenFilter as S } from "../filter-menu.context.js";
import "./filter-calendar.footer.js";
import "./filter-calendar.footer-apply.js";
import "./filter-calendar.footer-separator.js";
import "./filter-calendar.with-presets.js";
...
import { FilterCalendarComponent as y } from "./filter-calendar.component.js";
import { getDefaultSelection as A, getSelectedLabel as E } from "./util.js";
import { filterCalendarContentWrapper as L } from "../../../../galaxy-styles/dist/filter/filter-calendar.css.js";
const R = ({
  id: m,
  icon: a,
  tagLabel: c,
  ...
  mode: t,
  onValueClear: n,
  onValueApplyChange: s,
  ...g
}) => {
  const h = I(m, n), [D, l] = S(m), F = (w) => {
    s(w), p === "deferred" && l(!1);
  }, N = v(
    L,
    d
  ...
  const O = c ?? E(t, i, C, o);
  return /* @__PURE__ */ M(T, { open: D, onOpenChange: l, modal: !0, children: [
    /* @__PURE__ */ r(j, { asChild: !0, children: /* @__PURE__ */ r(
      q,
      {
        label: O,
        Icon: a,
        ...n !== void 0 && { onDismiss: h }
      }
    ) }),
    /* @__PURE__ */ r(x, { className: N, children: /* @__PURE__ */ r(
      y,
      {
        required: !0,
        mode: t,
