...
import { useMemo as j, useEffect as y } from "react";
/* empty css                                         */
...
import { DropdownMenuContent as A } from "../../../../components/dropdown-menu/dropdown-menu-content.js";
import "../../../../components/dropdown-menu/dropdown-menu-item.js";
import "../../../../components/dropdown-menu/dropdown-menu-label.js";
import { DropdownMenuRadioGroup as E } from "../../../../components/dropdown-menu/dropdown-menu-radio.js";
import { DropdownMenuRoot as R } from "../../../../components/dropdown-menu/dropdown-menu-root.js";
import "../../../../components/dropdown-menu/dropdown-menu-scrollable.js";
import { DropdownMenuSeparator as k } from "../../../../components/dropdown-menu/dropdown-menu-separator.js";
import { DropdownMenuSingleSelectItem as q } from "../../../../components/dropdown-menu/dropdown-menu-single-select.js";
import { DropdownMenuSub as G } from "../../../../components/dropdown-menu/dropdown-menu-sub.js";
import { DropdownMenuSubContent as L } from "../../../../components/dropdown-menu/dropdown-menu-sub-content.js";
import { DropdownMenuSubTrigger as z } from "../../../../components/dropdown-menu/dropdown-menu-sub-trigger.js";
import { DropdownMenuTrigger as B } from "../../../../components/dropdown-menu/dropdown-menu-trigger.js";
...
import { useClearFilter as J, useToggleOpenFilter as K } from "../filter-menu.context.js";
import "./filter-calendar.js";
import "./filter-calendar.footer.js";
import "./filter-calendar.footer-apply.js";
import "./filter-calendar.footer-separator.js";
import "../select/async/non-paginated/filter-select.async.js";
import "../select/async/paginated/filter-select.async-paginated.js";
import "../select/sync/filter-select.sync.js";
...
import { FilterMenuTag as Q } from "../filter-menu.tag.js";
import { FilterCalendarComponent as U } from "./filter-calendar.component.js";
import { generateCalendarSelectionId as M, getDefaultSelection as X, getSelectedLabel as Y } from "./util.js";
import { filterCalendarContentWrapper as _ } from "../../../../galaxy-styles/dist/filter/filter-calendar.css.js";
const $ = ({
  id: d,
  icon: w,
  tagLabel: D,
  ...
  timeZone: m,
  onValueClear: c,
  onValueApplyChange: n,
  ...F
}) => {
  const I = J(d, c), [N, h] = K(d), g = l === "deferred";
  if (g && !a)
    throw new Error(
      "Make sure to pass a value for `applyLabel` when using 'deferred' mode."
    );
  const C = j(() => f.map((r) => ({
    ...r,
    id: M(r.from, r.to, p, m)
  })), [f, p, m]), O = (r) => {
    const o = C.find((e) => e.id === r);
    o !== void 0 && n(o.from, o.to);
  }, P = (r) => {
    const { from: o, to: e } = r;
    o === void 0 || e === void 0 || (n(o, e), g && h(!1));
  }, T = H(
    _,
    S
  ), i = u ?? X("range", m);
  y(() => {
    u === void 0 && n(i.from, i.to);
  }, []);
  const W = M(
    i.from,
    i.to,
  ...
  return /* @__PURE__ */ s(R, { open: N, onOpenChange: h, modal: !0, children: [
    /* @__PURE__ */ t(B, { asChild: !0, children: /* @__PURE__ */ t(
      Q,
      {
        label: x,
        Icon: w,
        ...c !== void 0 && { onDismiss: I }
      }
    ) }),
    /* @__PURE__ */ s(A, { children: [
      /* @__PURE__ */ t(
        E,
        {
          value: W,
          onValueChange: O,
          children: C.map(({ label: r, id: o }) => /* @__PURE__ */ t(q, { value: o, children: r }, o))
        }
      ),
      /* @__PURE__ */ t(k, {}),
      /* @__PURE__ */ s(G, { children: [
        /* @__PURE__ */ t(z, { children: b }),
        /* @__PURE__ */ t(L, { className: T, children: /* @__PURE__ */ t(
          U,
          {
            required: !0,
            mode: "range",
...
$.displayName = "Filter.CalendarWithPresets";
export {
  $ as FilterCalendarWithPresets
};
