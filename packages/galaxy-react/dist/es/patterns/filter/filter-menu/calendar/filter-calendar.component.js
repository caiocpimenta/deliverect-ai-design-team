...
import { FilterCalendarFooter as S } from "./filter-calendar.footer.js";
...
import { filterCalendar as h } from "../../../../galaxy-styles/dist/filter/filter-calendar.css.js";
const x = ({
  applyLabel: o = "",
  applyMode: e,
  components: a,
  ...
  selected: t,
  className: n,
  onValueApplyChange: m,
  ...d
}) => {
  const [i, l] = u(t), r = e === "deferred";
  if (r && !o)
    throw new Error(
      "Make sure to pass a value for `applyLabel` when using 'deferred' mode."
    );
  const f = r ? i : t, c = r ? l : m, C = w(h, n);
  return /* @__PURE__ */ p(
    N,
    {
      ...d,
...
x.displayName = "Filter.CalendarComponent";
export {
  x as FilterCalendarComponent
};
