...
import { InputChip as f } from "../../../components/chip/input-chip/input-chip.js";
...
import { filterMenuTag as u } from "../../../galaxy-styles/dist/filter/filter-select.css.js";
const c = n(
  ({ label: r, Icon: o, onDismiss: i, className: t, ...m }, p) => {
    const e = l(u, t);
    return /* @__PURE__ */ a(
      f,
      {
        ...
        size: "lg",
        onDismiss: i,
        onDismissPointerDown: (s) => s.preventDefault(),
        className: e,
        ...m,
        children: r
      }
