...
import { DropdownMenuItem as n } from "../../../components/dropdown-menu/dropdown-menu-item.js";
...
import { DropdownMenuSub as l } from "../../../components/dropdown-menu/dropdown-menu-sub.js";
import { DropdownMenuSubContent as d } from "../../../components/dropdown-menu/dropdown-menu-sub-content.js";
import { DropdownMenuSubTrigger as u } from "../../../components/dropdown-menu/dropdown-menu-sub-trigger.js";
...
import { isNestedFilterConfig as s, resolveFilterKey as c } from "./util.js";
const b = ({
  config: r,
  onClick: i
}) => s(r) ? /* @__PURE__ */ e(l, { children: [
  /* @__PURE__ */ o(u, { icon: r.icon, children: r.label }),
  /* @__PURE__ */ o(d, { children: Object.entries(r.filterConfigs).map(([t, m]) => /* @__PURE__ */ o(
    b,
    {
      config: m,
      onClick: (p) => i(c(t, p))
...
] }) : /* @__PURE__ */ o(n, { icon: r.icon, onClick: () => i(void 0), children: r.label });
export {
  b as FilterMenuTreeItem
};
