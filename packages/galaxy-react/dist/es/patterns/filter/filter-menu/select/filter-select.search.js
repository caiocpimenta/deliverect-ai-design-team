...
import { DropdownMenuSeparator as a } from "../../../../components/dropdown-menu/dropdown-menu-separator.js";
...
import { InputField as l } from "../../../../primitives/input/input-field.js";
import { InputGroup as u } from "../../../../primitives/input/input-group.js";
import "../../../../primitives/input/input-label.js";
import { InputLeftAddon as f } from "../../../../primitives/input/input-left-addon.js";
...
import { SearchOutline as c } from "../../../../foundations/icons/search-outline.js";
...
import { filterSelectSearchInputGroup as s } from "../../../../galaxy-styles/dist/filter/filter-select.css.js";
const xt = ({
  onChange: p,
  ...m
}) => {
  ...
  return /* @__PURE__ */ t(e, { children: [
    /* @__PURE__ */ t(u, { className: s, children: [
      /* @__PURE__ */ r(f, { children: /* @__PURE__ */ r(c, {}) }),
      /* @__PURE__ */ r(
        l,
        {
          ref: i,
