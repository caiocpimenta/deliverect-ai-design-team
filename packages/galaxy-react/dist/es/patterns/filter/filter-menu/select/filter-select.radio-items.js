...
import { DropdownMenuRadioGroup as l } from "../../../../components/dropdown-menu/dropdown-menu-radio.js";
...
import { DropdownMenuSingleSelectItem as n } from "../../../../components/dropdown-menu/dropdown-menu-single-select.js";
...
import { FilterSelectEmptyItems as a } from "./filter-select.empty-items.js";
const vo = ({
  options: o,
  optionsEmptyLabel: m,
  value: i,
  ...
  return o.length === 0 ? /* @__PURE__ */ t(a, { label: m }) : /* @__PURE__ */ t(l, { value: i, onValueChange: p, children: o.map((r) => /* @__PURE__ */ t(
    n,
    {
      onSelect: e,
      value: r.value,
...
export {
  vo as FilterSelectMenuRadioItems
};
