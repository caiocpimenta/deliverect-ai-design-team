...
import { DropdownMenuContent as c } from "../../../../../components/dropdown-menu/dropdown-menu-content.js";
...
import { DropdownMenuRoot as a } from "../../../../../components/dropdown-menu/dropdown-menu-root.js";
...
import { DropdownMenuTrigger as g } from "../../../../../components/dropdown-menu/dropdown-menu-trigger.js";
...
import { useClearFilter as u, useToggleOpenFilter as d } from "../../filter-menu.context.js";
...
import { FilterMenuTag as f } from "../../filter-menu.tag.js";
const wt = ({
  id: r,
  icon: i,
  tagLabel: p,
  ...
  const e = u(r, t), [n, s] = d(r);
  return /* @__PURE__ */ l(a, { open: n, onOpenChange: s, children: [
    /* @__PURE__ */ o(g, { asChild: !0, children: /* @__PURE__ */ o(
      f,
      {
        label: p,
        Icon: i,
        ...t !== void 0 && { onDismiss: e }
      }
    ) }),
    /* @__PURE__ */ o(c, { align: "start", children: m })
  ] });
};
export {
  wt as FilterSelectAsyncContainer
};
