...
import { DropdownMenuContent as h } from "../../../../../components/dropdown-menu/dropdown-menu-content.js";
...
import { DropdownMenuTrigger as D } from "../../../../../components/dropdown-menu/dropdown-menu-trigger.js";
...
import { useClearFilter as M, useToggleOpenFilter as O } from "../../filter-menu.context.js";
...
import { FilterMenuTag as S } from "../../filter-menu.tag.js";
import { FilterSelectSyncContent as w } from "./filter-select.sync-content.js";
const x = ({
  id: o,
  icon: i,
  tagLabel: p,
  ...
  searchable: c,
  searchPlaceholder: a,
  onValueApplyChange: d,
  onValueClear: t
}) => {
  const u = M(o, t), [f, g] = O(o);
  return /* @__PURE__ */ F(C, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(D, { asChild: !0, children: /* @__PURE__ */ r(
      S,
      {
        label: p,
        Icon: i,
        ...t !== void 0 && { onDismiss: u }
      }
    ) }),
    /* @__PURE__ */ r(h, { align: "start", children: /* @__PURE__ */ r(
      w,
      {
        applyLabel: m,
        multiple: e,
