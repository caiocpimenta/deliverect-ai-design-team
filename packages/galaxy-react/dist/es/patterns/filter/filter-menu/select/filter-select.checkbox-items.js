...
import { DropdownMenuCheckboxItem as d } from "../../../../components/dropdown-menu/dropdown-menu-checkbox-item.js";
...
import { FilterSelectEmptyItems as n } from "./filter-select.empty-items.js";
const bm = ({
  options: o,
  optionsEmptyLabel: e,
  value: t,
  ...
  const c = (r, m) => {
    p(m ? [...t, r] : t.filter((l) => l !== r));
  };
  return o.length === 0 ? /* @__PURE__ */ i(n, { label: e }) : /* @__PURE__ */ i(h, { children: o.map((r) => /* @__PURE__ */ i(
    d,
    {
      checked: (t == null ? void 0 : t.includes(r.value)) || !1,
      onCheckedChange: (m) => c(r.value, m),
      children: r.label
    },
    r.value
  )) });
...
export {
  bm as FilterSelectCheckboxItems
};
