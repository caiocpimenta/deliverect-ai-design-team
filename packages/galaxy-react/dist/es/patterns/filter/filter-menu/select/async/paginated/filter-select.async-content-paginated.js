...
import { useState as d, useMemo as u, useEffect as y, useCallback as q } from "react";
...
import { DropdownMenuScrollable as B } from "../../../../../../components/dropdown-menu/dropdown-menu-scrollable.js";
...
import "../non-paginated/filter-select.async.js";
import "./filter-select.async-paginated.js";
...
import { FilterSelectApply as G } from "../../filter-select.apply.js";
import { FilterSelectCheckboxItems as J } from "../../filter-select.checkbox-items.js";
import { FilterSelectMenuRadioItems as K } from "../../filter-select.radio-items.js";
import { FilterSelectSearch as L } from "../../filter-select.search.js";
import { filterOptions as N } from "../../use-filtered-options.js";
import { FilterSelectAsyncLoading as Q } from "../filter-select.async-loading.js";
const im = ({
  options: m,
  optionsEmptyLabel: S,
  value: A,
  isFetchingOptions: r,
  isFetchingOptionsError: h,
  Error: R,
  multiple: C,
  applyLabel: k,
  searchable: w,
  searchTerm: e,
  searchPlaceholder: T,
  onSearchTermChange: l,
  onValueApplyChange: I,
  onReachScrollEnd: V,
  onOpenFilter: n
}) => {
  const [i, b] = d(A), [c, g] = d(!1), [a, j] = d(""), t = e !== void 0 && l !== void 0, s = u(
    () => t ? e : a,
    [t, a, e]
  ), D = u(
    () => t ? l : j,
    [t, l]
  ), v = u(() => t ? m : N(m, s), [m, s, t]), { ref: E, inView: x } = z();
  y(() => {
    x && !r && a === "" && V();
  }, [x]), y(() => {
    c && !r && g(!1);
  ...
  return /* @__PURE__ */ f(M, { children: [
    ...
    /* @__PURE__ */ f(B, { ref: W, children: [
      h ? R : c || r && m.length === 0 ? null : /* @__PURE__ */ f(M, { children: [
        C ? /* @__PURE__ */ o(
          J,
          {
            options: v,
        ...
        /* @__PURE__ */ o("div", { ref: E, style: { minHeight: "1px" } })
      ] }),
      (c || r) && /* @__PURE__ */ o(Q, {})
    ] }),
    !h && /* @__PURE__ */ o(
...
export {
  im as FilterSelectAsyncContentPaginated
};
