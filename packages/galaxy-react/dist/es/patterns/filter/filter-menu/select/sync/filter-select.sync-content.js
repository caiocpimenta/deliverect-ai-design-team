...
import { DropdownMenuScrollable as F } from "../../../../../components/dropdown-menu/dropdown-menu-scrollable.js";
...
import { FilterSelectApply as x } from "../filter-select.apply.js";
import { FilterSelectCheckboxItems as C } from "../filter-select.checkbox-items.js";
import { FilterSelectMenuRadioItems as I } from "../filter-select.radio-items.js";
import { FilterSelectSearch as g } from "../filter-select.search.js";
import { useFilteredOptions as v } from "../use-filtered-options.js";
const Vr = ({
  applyLabel: c,
  multiple: r,
  value: s,
  ...
  searchable: d,
  searchPlaceholder: h,
  onValueApplyChange: p
}) => {
  const [o, m] = n(s), [e, u] = n(""), l = v(a, e);
  return /* @__PURE__ */ S(f, { children: [
    ...
    /* @__PURE__ */ t(F, { children: r ? /* @__PURE__ */ t(
      C,
      {
        options: l,
        optionsEmptyLabel: i,
    ...
    /* @__PURE__ */ t(x, { label: c, onApply: () => {
      p(o);
    } })
  ] });
};
export {
  Vr as FilterSelectSyncContent
};
